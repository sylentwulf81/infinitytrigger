          ...
          <div className="container px-4 md:px-6">
            ...
            <div className="mx-auto max-w-3xl space-y-8">
              <div className="space-y-4">
                ...
                <p className="text-muted-foreground">
                  These Terms of Service ("Terms") constitute a legally binding agreement between you and Infinity
                  Trigger ("we," "our," or "us") regarding your access to and use of our website and services
              ...
              <div className="space-y-4">
                ...
                <p className="text-muted-foreground">
                  Infinity Trigger provides web and mobile application development services, including but not limited
                  to website design, application development, maintenance, and related consulting services.
                </p>
                <p className="text-muted-foreground">
              ...
              <div className="space-y-4">
                ...
                <p className="text-muted-foreground">If you engage our development services, you agree to:</p>
                <ul className="list-disc pl-6 text-muted-foreground space-y-2">
                  ...
                  <li>Pay all fees as agreed upon in the project proposal or contract</li>
                  <li>Obtain all necessary permissions and rights for materials provided to us</li>
                </ul>
              </div>

              <div className="space-y-4">
                <h2 className="text-2xl font-bold">5. Intellectual Property</h2>
                <h3 className="text-xl font-semibold">5.1 Our Intellectual Property</h3>
                <p className="text-muted-foreground">
                  The Services, including all content, features, and functionality, are owned by Infinity Trigger or our
                ...
                <p className="text-muted-foreground">
                  You retain ownership of all materials you provide to us. By providing materials to us, you grant us a
                  non-exclusive, worldwide, royalty-free license to use, reproduce, modify, and display such materials
                  solely for the purpose of providing the Services to you.
                </p>

                <h3 className="text-xl font-semibold">5.3 Deliverables</h3>
                <p className="text-muted-foreground">
                  Upon full payment of all applicable fees, we will assign to you all rights, title, and interest in the
                  deliverables specifically created for you, except for:
                </p>
                <ul className="list-disc pl-6 text-muted-foreground space-y-2">
                  <li>Third-party materials incorporated into the deliverables</li>
                  <li>Our pre-existing intellectual property</li>
                  <li>General programming techniques, algorithms, methods, or processes</li>
                </ul>
              </div>
              ...
              <div className="space-y-4">
                ...
                <p className="text-muted-foreground">
                  Payment terms will be specified in the project proposal or contract. Unless otherwise agreed upon:
                </p>
                <ul className="list-disc pl-6 text-muted-foreground space-y-2">
                  <li>A deposit may be required before work begins</li>
                  <li>Invoices are due upon receipt</li>
                  <li>Late payments may incur additional fees</li>
                  <li>We reserve the right to suspend work on projects with outstanding payments</li>
                </ul>
              </div>
              ...
              <div className="space-y-4">
                ...
                <p className="text-muted-foreground">
                  To the maximum extent permitted by law, in no event shall Infinity Trigger be liable for any indirect,
              ...
              <div className="space-y-4">
                ...
                <p className="text-muted-foreground">
                  You agree to defend, indemnify, and hold harmless Infinity Trigger and our officers, directors,
