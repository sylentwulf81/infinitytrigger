              ...
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  ...
                  <p className="max-w-[600px] text-gray-600 dark:text-brand-lavender/80 md:text-xl/relaxed lg:text-2xl/relaxed">
                    A daily writing companion designed to help you develop a consistent writing practice through thoughtful prompts, gentle encouragement, and distraction-free writing.
                  </p>
                </div>
            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center mb-12">
              <div className="space-y-2">
                ...
                <p className="max-w-[700px] text-gray-600 dark:text-brand-lavender/80 md:text-xl">
                  Meanwhile is a thoughtfully designed iOS application that helps users establish and maintain a daily writing habit.
                </p>
              </div>
            </div>
            ...
            <div className="grid gap-12 lg:grid-cols-2">
              <div className="space-y-6">
                <div className="space-y-4">
                  <h3 className="text-2xl font-bold text-brand-dark dark:text-brand-mint">The Inspiration</h3>
                  <p className="text-gray-700 dark:text-brand-lavender/80 leading-relaxed">
                    Many people want to write more regularly but struggle with consistency and motivation. Traditional journaling apps often lack the specific features needed to build a sustainable writing habit.
                  </p>
                  <p className="text-gray-700 dark:text-brand-lavender/80 leading-relaxed">
                    We created Meanwhile with a vision for an app that would specifically focus on helping users develop a daily writing practice through gentle encouragement, thoughtful prompts, and a distraction-free writing environment.
                  </p>
                </div>

                <div className="space-y-4 mt-8">
                  <h3 className="text-2xl font-bold text-brand-dark dark:text-brand-mint">Our Approach</h3>
                  <p className="text-gray-700 dark:text-brand-lavender/80 leading-relaxed">
                    We focused on understanding the psychology behind habit formation and what makes writing apps effective. Our approach centered on:
                  </p>
              ...
              <Card className="bg-white/50 dark:bg-brand-dark/50 border-brand-teal/20 dark:border-brand-mint/20">
                <CardContent className="pt-6">
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <h3 className="text-xl font-semibold text-brand-dark dark:text-brand-mint">Daily Prompts</h3>
                  </div>
                  <p className="text-gray-600 dark:text-brand-lavender/80">
                    Thoughtfully crafted writing prompts that inspire creativity and reflection, updated daily.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="bg-white/50 dark:bg-brand-dark/50 border-brand-teal/20 dark:border-brand-mint/20">
                <CardContent className="pt-6">
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <h3 className="text-xl font-semibold text-brand-dark dark:text-brand-mint">Streak Tracking</h3>
                  </div>
                  <p className="text-gray-600 dark:text-brand-lavender/80">
                    Build consistency with gentle reminders and motivating streak tracking.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="bg-white/50 dark:bg-brand-dark/50 border-brand-teal/20 dark:border-brand-mint/20">
                <CardContent className="pt-6">
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <h3 className="text-xl font-semibold text-brand-dark dark:text-brand-mint">Focus Mode</h3>
                  </div>
                  <p className="text-gray-600 dark:text-brand-lavender/80">
                    A distraction-free writing environment that helps you stay focused on your writing.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="bg-white/50 dark:bg-brand-dark/50 border-brand-teal/20 dark:border-brand-mint/20">
                <CardContent className="pt-6">
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <h3 className="text-xl font-semibold text-brand-dark dark:text-brand-mint">Quick Entry</h3>
                  </div>
                  <p className="text-gray-600 dark:text-brand-lavender/80">
                    Start writing in seconds with our streamlined interface and quick access tools.
                  </p>
                </CardContent>
              </Card>
            </div>
            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="mx-auto max-w-[700px] text-gray-600 dark:text-brand-lavender/80 md:text-xl">
                  Download Meanwhile today and discover the joy of daily writing.
                </p>
              </div>
